...
<div class="modal fade api-modal"
	id="{{ section_key }}_{{ link_key }}_modal" tabindex="-1" role="dialog"
			...
			<div class="modal-header">
				<div class="toggle-view hide">
					<div class="btn-group" role="group">
						<button type="button" data-display-toggle="data"
							class="btn btn-sm btn-info">Data</button>
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-lg-6 response" id="response">
							...
							<pre class="well response-raw hide">
								<div class="response-raw-request"></div>
								<div class="response-raw-response"></div>
							</pre>
						</div>
					</div>
				</div>
